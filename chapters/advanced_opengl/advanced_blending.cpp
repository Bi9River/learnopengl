...
int main() {
    ...
    // shader declaration
    Shader shader("../chapters/advanced_opengl/shaders_blending/blending_model.vert",
                  "../chapters/advanced_opengl/shaders_blending/blending_model.frag");
    ...
    // load textures
    unsigned int floorTexture = loadTexture(FileSystem::getPath("resources/container2.png").c_str());
    unsigned int transparentTexture = loadTexture(
            FileSystem::getPath("resources/blending_transparent_window.png").c_str());
